...
export default function JobPortal() {
  return (
    <div>
      ...
      {/* Working */}
      <section className="text-gray-600 bg-[#e7f3fd] body-font ">
      ...
      <section id="jobs" className=" py-16">
        <div className="w-4/5 mx-auto">
          ...
          <div className="flex justify-center mt-10">
            <button className="inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded-lg text-lg">
              View More
            </button>
          </div>
        </div>
      ...
      <footer class="text-gray-600 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <span class="ml-3 text-xl">EmpowerAbility</span>
          </a>
